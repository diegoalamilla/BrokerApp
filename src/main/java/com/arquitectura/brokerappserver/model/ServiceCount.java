        ...
        answerBuilder.add("servicio","contar")
                        .add("respuestas",3)
                            .add("respuesta1",listProducts.get(0).getNombre())
                                .add("valor1",DAOProductos.getNumberofVotesFromProduct(listProducts.get(0).getNombre()))
                                    .add("respuesta2",listProducts.get(1).getNombre())
                                        .add("valor2",DAOProductos.getNumberofVotesFromProduct(listProducts.get(1).getNombre()))
                                            .add("respuesta3",listProducts.get(2).getNombre())
                                                .add("valor3",DAOProductos.getNumberofVotesFromProduct(listProducts.get(2).getNombre()));
